...
3. 集成 Docker、Python3.x (带pip) 环境
4. 集成 onliner 在线用户插件，可查看在线用户地址等详细情况
5. 集成中文版 netdata 实时监控插件，小白也能轻松看懂系统概况
6. 集成应用过滤插件，支持游戏、视频、聊天、下载等 APP 过滤
7. X86_64 提供 vmdk 格式固件并集成 vm-tools
